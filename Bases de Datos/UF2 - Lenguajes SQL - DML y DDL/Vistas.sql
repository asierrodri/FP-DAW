...
-- 2.	Crea una vista actualizable llamada v_productos_sin_stock, con los datos de
-- los productos que no tienen stock, comprobar que se pueden modificar los datos y añadir datos.
...
WHERE stock=0
WITH CHECK OPTION;
SELECT * FROM v_productos_sin_stock;

UPDATE v_productos_sin_stock
SET precio = precio * 2
WHERE codigo = 15;
SELECT * FROM v_productos_sin_stock;

INSERT INTO v_productos_sin_stock VALUES(0, 'NUEVO PRODUCTO', 500, 1, 10, 0);
SELECT * FROM v_productos_sin_stock;